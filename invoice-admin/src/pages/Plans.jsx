        ...
        <div className="absolute inset-0 flex justify-center items-start pt-24 z-50 pointer-events-none">
          ...
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-6 relative pointer-events-auto animate-fadeIn">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                />
              </div>
            ...
            <div className="flex justify-end mt-8 space-x-3">
              ...
              <button
                onClick={handleSave}
                className="px-5 py-2 rounded-xl text-white bg-gradient-to-r from-emerald-500 via-blue-600 to-purple-600 hover:opacity-90 transition"
              >
                Save Changes
              </button>
            </div>

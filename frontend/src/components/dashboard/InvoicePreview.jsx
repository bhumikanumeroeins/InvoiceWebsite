...
Best regards`,
  ...
  const previewData = currentInvoice ? {
    ...
    shipTo: currentInvoice.shipTo,
    invoiceNumber: currentInvoice.invoiceNumber || currentInvoice.number,
    invoiceDate: currentInvoice.invoiceDate || currentInvoice.date,
    ...
    number: currentInvoice.number || currentInvoice.invoiceNumber,
    date: currentInvoice.date || currentInvoice.invoiceDate,
  } : {
    number: 'INV-001',

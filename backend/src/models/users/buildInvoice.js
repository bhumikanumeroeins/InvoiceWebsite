...
const invoiceCustomizationSchema = new mongoose.Schema(
  {
    ...
    content: {
      ...
      paymentInfoType: { type: String, enum: ["bank", "upi"], default: "bank" },
      ...
      upiId: { type: String, default: "business@upi" },
    ...
    logoPosition: {
      type: positionSchema,
      default: { x: 50, y: 200, width: 300, height: 40 },
    },
    invoiceMetaPosition: {
      type: positionSchema,
      default: { x: 500, y: 50, width: 200, height: 120 },
    },
    businessInfoPosition: {
      type: positionSchema,
      default: { x: 50, y: 260, width: 220, height: 150 },
    },
    clientInfoPosition: {
      type: positionSchema,
      default: { x: 290, y: 260, width: 220, height: 120 },
    },
    shipToPosition: {
      type: positionSchema,
      default: { x: 530, y: 260, width: 220, height: 120 },
    },
    itemsTablePosition: {
      type: positionSchema,
      default: { x: 50, y: 430, width: 700, height: 200 },
    },
    totalsPosition: {
      type: positionSchema,
      default: { x: 500, y: 650, width: 250, height: 120 },
    },
    termsPosition: {
      type: positionSchema,
      default: { x: 50, y: 650, width: 400, height: 120 },
    },
    paymentInfoPosition: {
      type: positionSchema,
      default: { x: 50, y: 780, width: 300, height: 120 },
    },
    qrCodePosition: {
      type: positionSchema,
      default: { x: 380, y: 780, width: 190, height: 100 },
    },
    signaturePosition: {
      type: positionSchema,
      default: { x: 560, y: 780, width: 190, height: 100 },
    },
    footerPosition: {
      type: positionSchema,
      default: { x: 50, y: 950, width: 700, height: 60 },
    },

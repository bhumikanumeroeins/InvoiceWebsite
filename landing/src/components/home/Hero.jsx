...
const Hero = () => {
  ...
  return (
    <section className="relative bg-slate-50 border-b border-slate-200 overflow-hidden" ref={ref}>
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-gradient-to-br from-indigo-100 to-emerald-100 opacity-50 blur-3xl" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full bg-gradient-to-br from-pink-100 to-orange-100 opacity-50 blur-3xl" />

      <div className="w-full py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <motion.div variants={textVariant} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }}>
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-extrabold text-slate-900 leading-tight mb-6">
              Invoicing made simple <br />for modern businesses
            </h1>
            <p className="text-sm text-slate-500 mt-4">No credit card required • 2 free invoices included</p>
            ...
            >
              ...
              <motion.a
                whileHover={{ scale: 1.05 }}
                href={`${APP_URL}/signup`}
                className="inline-flex items-center gap-2 px-7 py-4 border border-indigo-200 text-indigo-700 font-semibold rounded-lg hover:bg-indigo-50 transition"
              >
                Get started free
              </motion.a>
            </motion.div>
          ...
          {/* RIGHT – SCROLLING MULTI-PAGE STACK */}
          <div className="relative flex justify-center">
            <div className="relative w-full max-w-sm h-[460px]">
              ...
              >
                ...
                <div className="absolute top-2 right-2 px-2 py-0.5 bg-indigo-100 text-indigo-700 text-xs font-semibold rounded-full">Draft</div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute top-2 right-2 px-2 py-0.5 bg-yellow-100 text-yellow-700 text-xs font-semibold rounded-full">Sent</div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute top-2 right-2 px-2 py-0.5 bg-pink-100 text-pink-700 text-xs font-semibold rounded-full">Viewed</div>
              </motion.div>

              <motion.div style={{ y: page1Y }} className="relative rounded-lg shadow-xl overflow-hidden">
                <div className="flex items-center justify-between px-3 py-2 border-b border-slate-200 bg-emerald-50">
                  ...
                  <span className="px-2 py-0.5 bg-green-100 text-green-700 text-xs font-semibold rounded-full">Paid</span>
                </div>

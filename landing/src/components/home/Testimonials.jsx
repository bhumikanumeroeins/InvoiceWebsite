  ...
  <section id="testimonials" className="py-24 bg-slate-50">
    <div className="max-w-7xl mx-auto px-6">
      ...
      >
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mt-3 mb-4">Loved by businesses worldwide</h2>
        <p className="text-lg text-slate-600">See what our customers have to say about their experience.</p>
      </motion.div>
        ...
        {testimonials.map(({ name, role, image, content }) => (
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <img src={image} alt={name} className="w-14 h-14 rounded-full object-cover ring-2 ring-indigo-200 shadow-md" />
              <div>
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.3 }}
      >
        <p className="text-center text-slate-400 mb-8 font-medium">Trusted by companies worldwide</p>

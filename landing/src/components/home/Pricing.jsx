    ...
    <section id="pricing" className="py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 mt-3 mb-4">Simple, Transparent Pricing</h2>
        ...
        >
          {plans?.length > 0 &&
            plans.map((plan) => {
              ...
              const features = [
                plan.invoiceLimit === -1 ? 'Unlimited invoices' : `${plan.invoiceLimit} invoices total`,
                'All templates',
                'Email & reminders',
                'Payment tracking',
              ];

              const cta = isFree ? 'Start Free' : `Subscribe ${plan.planName}`;
                ...
                >
                  ...
                  <div className="text-center mb-8">
                    ...
                    <div className="flex items-baseline justify-center gap-1">
                      ...
                      <span className={isPopular ? 'text-white/80' : 'text-gray-500'}>/{period}</span>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-4 mb-8">
                    {features.map((feature) => (
                      <li key={feature} className="flex items-center gap-3">
                        ...
                        >
                          <Check className={`w-3 h-3 ${isPopular ? 'text-white' : 'text-indigo-600'}`} />
                        </div>
                  ...
                  <a
                    href={`${APP_URL}/signup`}
                    className={`block w-full py-4 px-6 rounded-full font-semibold transition-all text-center ${
                      isPopular

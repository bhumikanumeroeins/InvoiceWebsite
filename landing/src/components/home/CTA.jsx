...
const CTA = () => (
  <section className="py-24 bg-slate-900 relative overflow-hidden">
    ...
    >
      ...
      <motion.p variants={fadeUp} className="text-xl text-slate-300 max-w-2xl">
        Join over 100,000 businesses using InvoicePro to create professional invoices and get paid on time.
      </motion.p>

      <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
        <a
          href={`${APP_URL}/create/invoice`}
      ...
      <motion.p variants={fadeUp} className="mt-8 text-slate-400 text-sm">
